...
export class RuleContext {
     ...
     */
    constructor({ id, severity, options, sourceCode, filename, messages }) {
        this.id = id;
        ...
        // Provide languageOptions for rules that inspect ecmaVersion
        this.languageOptions = { ecmaVersion: 2024 };
    }
