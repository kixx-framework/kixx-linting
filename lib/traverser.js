...
// CodePathAnalyzer is CommonJS (the vendored module uses require())
const CodePathAnalyzer = require("./vendor/code-path-analysis/index.cjs");
...
function _traverse(node, parent, visitorKeys, eventGenerator) {
    ...
    if (keys) {
        ...
        // Unknown node type: try to visit any property that looks like a child node
