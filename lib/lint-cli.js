...
/**
 * CLI runtime options.
 * @typedef {Object} RunLintCliOptions
 * @property {string[]} [argv=[]] - Positional CLI arguments after the executable and script name.
 * @property {string} [cwd=process.cwd()] - Working directory used to resolve the target and load `eslint.config.js`.
 * @property {Object} [stderr=process.stderr] - Writable stream for diagnostics and operational errors.
 * @property {function(string): boolean} [stderr.write] - Writes one formatted output line or diagnostic block.
 */
 ...
 * setup error occurs.
 *
 * @param {RunLintCliOptions} [args] - CLI runtime options.
