...
- [ ] **Inventory public scope behavior**
...
- [ ] **Add baseline scope parity tests**
...
- [ ] **Add linter integration regression tests**
...
- [ ] **Create new module skeleton and attribution**
...
- [ ] **Port syntax constants and visitor keys**
...
- [ ] **Port variable and definition models**
...
- [ ] **Update baseline tests to target new module**
...
- [ ] **Run targeted scope-dependent rule tests**
...
- [ ] **Run project lint and fix style**
...
- [ ] **Remove obsolete vendored dependency usage**
