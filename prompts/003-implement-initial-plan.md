...
The implementation plan to follow is at plans/implementation-plan.md
...
If your context window contains 125,000 tokens, or more, then STOP and let the user know that you are stopping. Otherwise move on to the next open (incomplete) TODO item.
